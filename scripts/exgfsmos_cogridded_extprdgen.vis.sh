#!/bin/sh
##########################################################################
#  Job Name: exgfsmos_cogridded_extprdgen.vis.sh.ecf 
...
##########################################################################
#
PS4='cogridded_extprdgen.vis $SECONDS +'
#PS4='${PMI_FORK_RANK} $SECONDS ${0/\/gpfs\/hps\/nco\/ops\/nw.*\/gfs_mos.*\/scripts/} +'
set -x
echo MDLLOG: `date` - Begin job exgfsmos_cogridded_extprdgen.vis
...
startmsg
export FORT10="ncepdate"
export FORT17="$FIXgfs_mos/mdl_gmoscobogusfile.vis"
export FORT18="$FIXgfs_mos/mdl_stationradii_co.vis"
export FORT26="$FIXgfs_mos/mdl_granlsta_co_vis.lst"
export FORT27="$FIXgfs_mos/mdl_granlsta_co.tbl"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT30="mdl_grd2grd_co_sq.vis.$cycle"
export FORT32="mdl_gfspkd.$cycle"
export FORT36="$FIXgfs_mos/mdl_gmoscobogusfile.vis"
export FORT37="$FIXgfs_mos/mdl_granlstation_copairs"
export FORT38="$FIXgfs_mos/mdl_gfsxgranlids_co.vis.$cycle"
export FORT44="$FIXgfs_mos/mdl_analysisgrconst_co"
export FORT63="$FIXgfs_mos/mdl_u405aviscocn"
export FORT80="mdl_gfsxmergesta_co.vis.$cycle"
...
export FORT26="$FIXgfs_mos/mdl_granlsta_co.lst"
export FORT27="$FIXgfs_mos/mdl_granlsta_co.tbl"
export FORT28="$FIXgfs_mos/mdl_gfsxgrpost_co.vis.$cycle"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT42="mdl_gfsgmosco.vis.$cycle"
...
#######################################################################
echo MDLLOG: `date` - Job exgfsmos_cogridded_extprdgen.vis has ended.
#######################################################################

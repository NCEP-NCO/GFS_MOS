#!/bin/sh
##########################################################################
#  Job Name: exgfsmos_cogridded_extprdgen.prcp.sh.ecf 
...
##########################################################################
#
PS4='cogridded_extprdgen.prcp $SECONDS +'
#PS4='${PMI_FORK_RANK} $SECONDS ${0/\/gpfs\/hps\/nco\/ops\/nw.*\/gfs_mos.*\/scripts/} +'
set -x

echo MDLLOG: `date` - Begin job exgfsmos_cogridded_extprdgen.prcp

cd $DATA/cogridded/prcp
cpreq $DATA/ncepdate .
...
export FORT31="$FIXgfs_mos/mdl_gfsxvect2grid_cogoe.in.prcp.$cycle"
export FORT32="$FIXgfs_mos/mdl_gfsxvect2grid_cogoe.out.prcp.$cycle"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT48="mdl_goemos.$cycle"
export FORT60="mdl_cogoemosxgrsq.prcp.$cycle"
$EXECcode/mdl_vect2grid < $PARMgfs_mos/mdl_vect2grid_cogoe.cn >> $pgmout 2>errfile
export err=$?; err_chk
...
startmsg
export FORT10="ncepdate"
export FORT39="$FIXgfs_mos/mdl_stationradii_co.pqpf"
export FORT40="$FIXgfs_mos/mdl_gmoscobogusfile.pqpf"
export FORT26="$FIXgfs_mos/mdl_granlsta_co.lst"
export FORT27="$FIXgfs_mos/mdl_granlsta_co.tbl"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT30="mdl_cogoemosxgrsq.prcp.$cycle"
export FORT32="mdl_gfspkd.$cycle"
export FORT37="$FIXgfs_mos/mdl_granlstation_copairs"
export FORT38="$FIXgfs_mos/mdl_gfsxgranlids_co.prcp.$cycle"
...
export FORT55="$FIXgfs_mos/mdl_u405apop6cocn"
export FORT56="$FIXgfs_mos/mdl_u405apop12cocn"
export FORT61="$FIXgfs_mos/mdl_u405aqpf1cocn"
export FORT62="$FIXgfs_mos/mdl_u405aqpfcocn"
export FORT63="$FIXgfs_mos/mdl_u405asnwcocn"
export FORT80="mdl_gfsmergesta_co.$cycle"
export FORT81="mdl_gfsxmergesta_co.prcp.$cycle"
export FORT42="mdl_gfsgmosco.prcp.$cycle"
...
export FORT26="$FIXgfs_mos/mdl_granlsta_co.lst"
export FORT27="$FIXgfs_mos/mdl_granlsta_co.tbl"
export FORT28="$FIXgfs_mos/mdl_gfsxgrpost_co.prcp.$cycle"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT42="mdl_gfsgmosco.prcp.$cycle"
...
#######################################################################
echo MDLLOG: `date` - Job gfsmos_cogridded_extprdgen.prcp has ended.
#######################################################################

#!/bin/sh
#######################################################################
#  Job Name: exgfsmos_cogridded_prdgen.wind.sh.ecf 
...
#######################################################################
#
PS4='cogridded_prdgen.wind $SECONDS +'
#PS4='${PMI_FORK_RANK} $SECONDS ${0/\/gpfs\/hps\/nco\/ops\/nw.*\/gfs_mos.*\/scripts/} +'
set -x
echo MDLLOG: `date` - Begin job exgfsmos_cogridded_prdgen.wind

cd $DATA/cogridded/wind
cpreq $DATA/ncepdate .
...
export FORT28="$FIXgfs_mos/mdl_gfsramerge_co.wind.$cycle"                          #INPUT VARIABLE LIST
...
export FORT60="mdl_gfsmergesta_co.wind.$cycle"
...
export FORT31="$FIXgfs_mos/mdl_gfsvect2grid_codmo.in.wind.$cycle"
export FORT32="$FIXgfs_mos/mdl_gfsvect2grid_codmo.out.wind.$cycle"
export FORT29="$FIXcode/mdl_mos2000id.tbl"                                     #INPUT MOS2000 ID TABLE
export FORT61="mdl_goemosmodel.$cycle"
export FORT60="mdl_cogoedmogrsq.wind.$cycle"
...
#######################################################################
cpreq $FIXcode/mdl_rafile_template_large mdl_gfsgmosco.wind.$cycle
...
export FORT11="$FIXgfs_mos/mdl_granlstation_cowsppairs"                            #INPUT STATION PAIRS
export FORT13="$FIXgfs_mos/mdl_gmoscobogusfile.wspd"                               #INPUT BOGUS LIST
export FORT14="$FIXgfs_mos/mdl_stationradii_co.wspd"                               #INPUT RADII FILE
export FORT15="$FIXgfs_mos/mdl_gmoscobogusfile.wgst"                               #INPUT BOGUS LIST
export FORT16="$FIXgfs_mos/mdl_stationradii_co.wgst"                               #INPUT RADII FILE
export FORT26="$FIXgfs_mos/mdl_granlsta_co.lst"                                    #INPUT STATION LIST
export FORT27="$FIXgfs_mos/mdl_granlsta_co.tbl"                                    #INPUT STATION TABLE
export FORT29="$FIXcode/mdl_mos2000id.tbl"                                     #INPUT MOS2000 ID TABLE
export FORT30="mdl_cogoedmogrsq.wind.$cycle"                                   #OUTPUT SEQUENTIAL FILE
export FORT32="mdl_gfspkd.$cycle"
export FORT33="$FIXgfs_mos/mdl_granlsta_copairs.wgst"                              #INPUT STATION PAIRS
export FORT37="$FIXgfs_mos/mdl_granlstation_copairs"                               #INPUT STATION PAIRS
export FORT38="$FIXgfs_mos/mdl_gfsgranlids_co.wind.$cycle"                         #INPUT ID LIST
export FORT44="$FIXgfs_mos/mdl_analysisgrconst_co"                                 #INPUT GRIDDED CONSTANT FILE
export FORT57="$FIXgfs_mos/mdl_u405awspcocn"                                       #INPUT WSP CONTROL FILE
export FORT58="$FIXgfs_mos/mdl_u405awucocn"                                        #INPUT CONTROL FILE
export FORT59="$FIXgfs_mos/mdl_u405awvcocn"                                        #INPUT CONTROL FILE
export FORT60="$FIXgfs_mos/mdl_u405awgstcocn"                                      #INPUT CONTROL FILE
export FORT80="mdl_gfsmergesta_co.wind.$cycle"
export FORT81="mdl_gfsxmergesta_co.$cycle"
export FORT42="mdl_gfsgmosco.wind.$cycle"
...
export FORT26="$FIXgfs_mos/mdl_granlsta_co.lst"                                    #INPUT STATION LIST
export FORT27="$FIXgfs_mos/mdl_granlsta_co.tbl"                                    #INPUT STATION TABLE
export FORT28="$FIXgfs_mos/mdl_gfsgrpost_co.wind.$cycle"                           #INPUT ID LIST
export FORT29="$FIXcode/mdl_mos2000id.tbl"                                     #INPUT MOS2000 ID TABLE
export FORT42="mdl_gfsgmosco.wind.$cycle"
...
#######################################################################
echo MDLLOG: `date` - Job exgfsmos_cogridded_prdgen.wind has ended.
#######################################################################

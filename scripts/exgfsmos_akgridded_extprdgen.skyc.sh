#!/bin/sh
##########################################################################
#  Job Name: exgfsmos_akgridded_extprdgen.skyc.sh.ecf 
...
##########################################################################
#
PS4='akgridded_extprdgen.skyc $SECONDS +'
#PS4='${PMI_FORK_RANK} $SECONDS ${0/\/gpfs\/hps\/nco\/ops\/nw.*\/gfs_mos.*\/scripts/} +'
echo MDLLOG: `date` - Begin job exgfsmos_akgridded_extprdgen.skyc
...
############################################################################
#
if [ ! -f $COMIN/mdl_gfsgmosak.skyc.$cycle ]
     then echo 'need successful run of gfsmos_akgridded_prdgen.skyc to run properly' >> $pgmout
             export err=1;err_chk
fi

cpreq $COMIN/mdl_gfsgmosak.skyc.$cycle .
...
export FORT31="$FIXgfs_mos/mdl_gfsxvect2grid_akgoe.in.skyc.$cycle"
export FORT32="$FIXgfs_mos/mdl_gfsxvect2grid_akgoe.out.skyc.$cycle"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT48="mdl_goeakmos.$cycle"
export FORT60="mdl_akxgoegrsq.skyc.$cycle"
...
export FORT26="$FIXgfs_mos/mdl_granlsta_ak.lst"
export FORT27="$FIXgfs_mos/mdl_granlsta_ak.tbl"
export FORT18="$FIXgfs_mos/mdl_stationradii_ak.sky"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT30="mdl_akxgoegrsq.skyc.$cycle"
export FORT32="gfspkdfull.$cycle"
export FORT33="gfsxxpkdtimtrp.$cycle"
export FORT37="$FIXgfs_mos/mdl_granlstation_akpairs"
export FORT38="$FIXgfs_mos/mdl_gfsxgranlids_ak.skyc.$cycle"
...
export FORT63="$FIXgfs_mos/mdl_u405askyakcn"
export FORT80="mdl_gfsmergesta_ak.$cycle"
export FORT81="mdl_gfsxmergesta_ak.skyc.$cycle"
...
export FORT26="$FIXgfs_mos/mdl_granlsta_ak.lst"
export FORT27="$FIXgfs_mos/mdl_granlsta_ak.tbl"
export FORT28="$FIXgfs_mos/mdl_gfsxgrpost_ak.skyc.$cycle"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT42="mdl_gfsgmosak.skyc.$cycle"
export FORT60="mdl_gfsxgmosaksq.skyc.$cycle"
startmsg
...
#######################################################################
echo MDLLOG: `date` - Job exgfsmos_akgridded_extprdgen.skyc has ended.
#######################################################################

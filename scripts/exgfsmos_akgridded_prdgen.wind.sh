#!/bin/sh
#######################################################################
#  Job Name: exgfsmos_akgridded_prdgen.wind.sh.ecf 
...
#
set -x
PS4='akgridded_prdgen.wind $SECONDS +'
#PS4='${PMI_FORK_RANK} $SECONDS ${0/\/gpfs\/hps\/nco\/ops\/nw.*\/gfs_mos.*\/scripts/} +'
echo MDLLOG: `date` - Begin job exgfsmos_akgridded_prdgen.wind

cd $DATA/akgridded/wind
cpreq $DATA/ncepdate .
...
export FORT28="$FIXgfs_mos/mdl_gfsramerge_ak.wind.$cycle"                          #INPUT VARIABLE LIST
...
export FORT60="mdl_gfsmergesta_ak.wind.$cycle"
...
export FORT31="$FIXgfs_mos/mdl_gfsvect2grid_akdmo.in.wind.$cycle"                  #INPUT VARIABLE LIST
export FORT32="$FIXgfs_mos/mdl_gfsvect2grid_akdmo.out.wind.$cycle"                 #INPUT VARIABLE LIST ?
export FORT29="$FIXcode/mdl_mos2000id.tbl"                                     #INPUT MOS2000 ID TABLE
export FORT61="mdl_goeakmosmodel.$cycle"
export FORT60="mdl_akdmogrsq.wind.$cycle"
...
#######################################################################
cpreq $FIXcode/mdl_rafile_template mdl_gfsgmosak.wind.$cycle
...
export FORT26="$FIXgfs_mos/mdl_granlsta_ak.lst"                                    #INPUT STATION LIST
export FORT27="$FIXgfs_mos/mdl_granlsta_ak.tbl"                                    #INPUT STATION TABLE
export FORT16="$FIXgfs_mos/mdl_stationradii_ak.wspd"                               #INPUT RADII FILE
export FORT21="$FIXgfs_mos/mdl_gmosakbogusfile.wind"                               #INPUT BOGUS LIST
export FORT28="$FIXgfs_mos/mdl_stationradii_ak.wgst"                               #INPUT RADII FILE
export FORT29="$FIXcode/mdl_mos2000id.tbl"                                     #INPUT MOS2000 ID TABLE
export FORT30="mdl_akdmogrsq.wind.$cycle"                                      #OUTPUT SEQUENTIAL FILE
export FORT32="mdl_gfspkd.$cycle"
export FORT37="$FIXgfs_mos/mdl_granlstation_akpairs"                               #INPUT STATION PAIR
export FORT38="$FIXgfs_mos/mdl_gfsgranlids_ak.wind.$cycle"                         #INPUT ID LIST
export FORT44="$FIXgfs_mos/mdl_analysisgrconst_ak"                                 #INPUT GRIDDED CONSTANT FILE
export FORT58="$FIXgfs_mos/mdl_u405awuakcn"                                        #INPUT CONTROL FILE
export FORT59="$FIXgfs_mos/mdl_u405awvakcn"                                        #INPUT CONTROL FILE
export FORT60="$FIXgfs_mos/mdl_u405awspakcn"                                       #INPUT CONTROL FILE
export FORT61="$FIXgfs_mos/mdl_u405awdirakcn"                                      #INPUT CONTROL FILE
export FORT62="$FIXgfs_mos/mdl_u405awgstakcn"                                      #INPUT CONTROL FILE
export FORT80="mdl_gfsmergesta_ak.wind.$cycle"
export FORT81="mdl_gfsxmergesta_ak.$cycle"
export FORT42="mdl_gfsgmosak.wind.$cycle"
...
export FORT26="$FIXgfs_mos/mdl_granlsta_ak.lst"                                    #INPUT STATION LIST
export FORT27="$FIXgfs_mos/mdl_granlsta_ak.tbl"                                    #INPUT STATION TABLE
export FORT28="$FIXgfs_mos/mdl_gfsgrpost_ak.wind.$cycle"                           #INPUT ID LIST
export FORT29="$FIXcode/mdl_mos2000id.tbl"                                     #INPUT MOS2000 ID TABLE
export FORT42="mdl_gfsgmosak.wind.$cycle"
export FORT60="mdl_gfsgmosaksq_pp.wind.$cycle"
startmsg
...
#######################################################################
echo MDLLOG: `date` - Job exgfsmos_akgridded_prdgen.wind has ended.
#######################################################################

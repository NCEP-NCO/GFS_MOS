...
#
#######################################################################
#  Job Name: exgfsmos_copopo3_extprdgen.sh 
...
export FORT28="$FIXgfs_mos/mdl_gfsxpopocoprd.$cycle"  #PS 2013-12-12: Changed RF IDs to approved values
...
export FORT30="$FIXgfs_mos/mdl_gmosxcopopo.04010930.$cycle"  #PS 2013-12-13 added PoPO warm season
export FORT31="$FIXgfs_mos/mdl_gmosxcopopo.10010331.$cycle"  #PS 2013-12-13 added PoPO cool season
export FORT32="$FIXgfs_mos/mdl_gmosxcopopo3.04010930.$cycle" #TLH 2013-11-08 should this be renamed?
export FORT33="$FIXgfs_mos/mdl_gmosxcopopo3.10010331.$cycle" #TLH 2013-11-08 should this be renamed?
export FORT49="mdl_gfsxpopo3_ra.$PDY$cyc"
...
#######################################################################
#
cpreq $FIXcode/mdl_rafile_template mdl_gfsxpopo3_grra.$PDY$cyc
...
export FORT32="$FIXgfs_mos/mdl_gfsxvect2grid_popo.out.$cycle" 
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT42="mdl_gfsxpopo3_grra.$PDY$cyc"
export FORT48="mdl_gfsxpopo3_ra.$PDY$cyc"
export FORT60="mdl_gfsxpopo3_grsq.$PDY$cyc"
...
startmsg
export FORT10="ncepdate"
export FORT24="mdl_gfsxpopo3_grsq.$PDY$cyc"
...
export FORT30="mdl_gfsxgrpostpopo_grsq.$PDY$cyc"
...
#######################################################################
#
cpreq $FIXcode/mdl_rafile_template mdl_gfsxgrpostpopo_grra.$PDY$cyc
...
export FORT33="$FIXgfs_mos/mdl_gmosxcogb2sect4popo.$cycle"
export FORT34="$FIXgfs_mos/mdl_gmosxcogb2sect5popo.$cycle"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT44="mdl_gfsxgrpostpopo_grra.$PDY$cyc"
export FORT60="mdl_gmosxcogb2popo.$cycle.nohead"
...
. prep_step
startmsg
export FORT11="mdl_gmosxcogb2popo.$cycle.nohead"
export FORT12="filesize"
export FORT31=
export FORT51="mdl_gmosxcogb2popo.$cycle.temp"
$TOCGRIB2SUPER < $FIXgfs_mos/mdl_gmosxcogb2headpopo.$cycle 1>> $pgmout 2>> errfile
export err=$?; err_chk

echo `ls -l mdl_gmosxcogb2popo.$cycle.temp | awk '{print $5}'` > filesize
export pgm=tocgrib2super
. prep_step
startmsg
export FORT11="mdl_gmosxcogb2popo.$cycle.temp"
export FORT12="filesize"
export FORT31=
export FORT51="mdl_gmosxcogb2popo.xtrn.$cycle"
$TOCGRIB2SUPER < $FIXgfs_mos/mdl_gmosxcogb2headpopo.$cycle 1>> $pgmout 2>> errfile
export err=$?; err_chk
#
########################################################################
...
if test $SENDCOM = 'YES'
then
   cpfs mdl_gfsxpopo3_grsq.$PDY$cyc $COMOUT/mdl_gfsxpopo3_grsq.$cycle
   # SEND GRIB2 FILE WITH NO HEADERS TO $COMOUT
   cpfs mdl_gmosxcogb2popo.$cycle.nohead $COMOUT/mdl_gmosxcogb2popo.$cycle
fi

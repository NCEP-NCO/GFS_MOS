...
#
#######################################################################
#  Job Name: exgfsmos_akpopo3_prdgen.sh 
...
#  Remarks: None
#
#  HISTORY: 2012-08-24  Huntemann  New job for Alaska 3 km Gridded
#                                  MOS popo3.
...
#           2013-11-14  Huntemann  Updated for operations.
#           2013-12-04  Scallion   Removed sleep. Copy input data to
...
export FORT28="$FIXgfs_mos/mdl_gfspopoakprd.$cycle"  #PS 2013-12-12: Changed RF IDs to approved values
...
export FORT30="$FIXgfs_mos/mdl_gmosakpopo.04010930.$cycle"  #PS 2013-12-13 added PoPO warm season
export FORT31="$FIXgfs_mos/mdl_gmosakpopo.10010331.$cycle"  #PS 2013-12-13 added PoPO cool season
export FORT32="$FIXgfs_mos/mdl_gmosakpopo3.04010930.$cycle"
export FORT33="$FIXgfs_mos/mdl_gmosakpopo3.10010331.$cycle"
export FORT49="mdl_gfspopo3_ra.$PDY$cyc"
...
#######################################################################
#
cpreq $FIXcode/mdl_rafile_template mdl_gfspopo3_grra_u155fg.$PDY$cyc
...
export FORT32="$FIXgfs_mos/mdl_gfsvect2grid_popo.fg.$cycle"  
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT42="mdl_gfspopo3_grra_u155fg.$PDY$cyc"
export FORT48="mdl_gfspopo3_ra.$PDY$cyc"
export FORT60="mdl_gfspopo3_grsq_u155fg.$PDY$cyc"
...
#######################################################################
#
cpreq $FIXcode/mdl_rafile_template mdl_akgfspopo3_grra.$PDY$cyc
...
startmsg
export FORT10="ncepdate"
export FORT30="mdl_gfspopo3_grsq_u155fg.$PDY$cyc"
export FORT44="$FIXgfs_mos/mdl_analysisgrconst_akwx"
export FORT42="mdl_akgfspopo3_grra.$PDY$cyc"
export FORT31="mdl_akgfspopo3_grsq.$PDY$cyc"
export FORT26="$FIXgfs_mos/mdl_granlsta.lst"
export FORT27="$FIXgfs_mos/mdl_granlsta.tbl"
export FORT38="$FIXgfs_mos/mdl_gfspopogranlids_ak.$cycle"  #PS 2013-12-13 Added IDs for PoPO
...
startmsg
export FORT10="ncepdate"
export FORT24="mdl_akgfspopo3_grsq.$PDY$cyc"
export FORT26="$FIXgfs_mos/mdl_granlsta.lst"
export FORT27="$FIXgfs_mos/mdl_granlsta.tbl"
...
export FORT30="mdl_akgfsgrpostpopo_grsq.$PDY$cyc"
...
#######################################################################
#
cpreq $FIXcode/mdl_rafile_template mdl_akgfsgrpostpopo_grra.$PDY$cyc
...
export FORT33="$FIXgfs_mos/mdl_gmosakgb2sect4popo.t"$cyc"z"
export FORT34="$FIXgfs_mos/mdl_gmosakgb2sect5popo.t"$cyc"z"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT44="mdl_akgfsgrpostpopo_grra.$PDY$cyc"
export FORT60="mdl_gmosakgb2popo.$cycle.nohead"
...
. prep_step
startmsg
export FORT11="mdl_gmosakgb2popo.$cycle.nohead"
export FORT12="filesize"
export FORT31=
export FORT51="mdl_gmosakgb2popo.$cycle.temp"
$TOCGRIB2SUPER < $FIXgfs_mos/mdl_gmosakgb2headpopo.$cycle 1>> $pgmout 2>> errfile
export err=$?; err_chk

echo `ls -l mdl_gmosakgb2popo.$cycle.temp | awk '{print $5}'` > filesize
export pgm=tocgrib2super
. prep_step
startmsg
export FORT11="mdl_gmosakgb2popo.$cycle.temp"
export FORT12="filesize"
export FORT31=
export FORT51="mdl_gmosakgb2popo.xtrn.$cycle"
$TOCGRIB2SUPER < $FIXgfs_mos/mdl_gmosakgb2headpopo.$cycle 1>> $pgmout 2>> errfile
export err=$?; err_chk
#
########################################################################
...
if test $SENDCOM = 'YES'
then
   cpfs mdl_akgfspopo3_grsq.$PDY$cyc $COMOUT/mdl_akgfspopo3_grsq.$cycle
   # SEND GRIB2 FILE WITH NO HEADERS TO $COMOUT
   cpfs mdl_gmosakgb2popo.$cycle.nohead $COMOUT/mdl_gmosakgb2popo.$cycle
fi

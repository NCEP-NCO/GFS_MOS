#!/bin/sh
#######################################################################
#  Job Name: exgfsmos_cogridded_prdgen.prcp.sh.ecf 
...
#######################################################################
#
PS4='cogridded_prdgen.prcp $SECONDS +'
#PS4='${PMI_FORK_RANK} $SECONDS ${0/\/gpfs\/hps\/nco\/ops\/nw.*\/gfs_mos.*\/scripts/} +'
set -x
echo MDLLOG: `date` - Begin job exgfsmos_cogridded_prdgen.prcp
...
export FORT31="$FIXgfs_mos/mdl_gfsvect2grid_cogoe.in.prcp.$cycle"
export FORT32="$FIXgfs_mos/mdl_gfsvect2grid_cogoe.out.prcp.$cycle"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT48="mdl_goemos.$cycle"
export FORT60="mdl_cogoemosgrsq.prcp.$cycle"
...
#######################################################################
cpreq $FIXcode/mdl_rafile_template_large mdl_gfsgmosco.prcp.$cycle
...
export FORT26="$FIXgfs_mos/mdl_granlsta_co.lst"
export FORT27="$FIXgfs_mos/mdl_granlsta_co.tbl"
export FORT28="$FIXgfs_mos/mdl_granlsta_copairs.tmp"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT30="mdl_cogoemosgrsq.prcp.$cycle"
export FORT32="mdl_gfspkd.$cycle"
export FORT37="$FIXgfs_mos/mdl_granlstation_copairs"
export FORT38="$FIXgfs_mos/mdl_gfsgranlids_co.prcp.$cycle"
...
export FORT80="mdl_gfsmergesta_co.prcp.$cycle"
...
export FORT26="$FIXgfs_mos/mdl_granlsta_co.lst"
export FORT27="$FIXgfs_mos/mdl_granlsta_co.tbl"
export FORT28="$FIXgfs_mos/mdl_gfsgrpost_co.prcp.$cycle"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT42="mdl_gfsgmosco.prcp.$cycle"
...
#######################################################################
echo MDLLOG: `date` - Job exgfsmos_cogridded_prdgen.prcp has ended.
#######################################################################

...
#
#######################################################################
#  Job Name: exgfsmos_akwx_prdgen.sh 
#  Purpose: To run all steps necessary to create GFS-based gridded 
#           MOS Predominant Weather fcsts on the Alaska Grid.
#
#  Remarks: None
#
...
#           2016-02-08  Scallion   MDL  Configured for MPMD. Also, add
#                                       run of itdlp before mdl_wxgrid.
...
#######################################################################
#  COPY ALASKA GMOS DATA FROM COM
#######################################################################
cpreq $COMIN/mdl_gfsgmosak.${cycle} .
cpreq $COMIN/mdl_akgfspopo3_grsq.${cycle} .
cpreq $COMIN/mdl_akgfsptype_grsq.${cycle} .
...
. prep_step
startmsg
export FORT50="mdl_wxgrid_gfsgmosak.${cycle}"
...
#
#######################################################################
export FORT20="mdl_gfsgmosak.$cycle"
export FORT21="mdl_gfsgmosaksq.$cycle"
...
export FORT38="$FIXgfs_mos/mdl_gfswxgranlids_ak.$cycle"
...
export FORT31="mdl_wxgrid_gfsgmosaksq.${cycle}"                 # sequential gridded output
...
export FORT35="mdl_wxkeys_aktxt.${cycle}"                       # output ascii keylist
export FORT43="mdl_wxgrid_gfsgmosak.${cycle}"                   # random access gridded output
export FORT76="mdl_akgmoswxtrim_grsq.${cycle}"                        # grsq GMOS Input
export FORT77="mdl_akgfspopo3_grsq.${cycle}"                    # grsq popo3
export FORT78="mdl_akgfsptype_grsq.${cycle}"                    # grsq ptype
...
. prep_step
startmsg
export FORT50="mdl_wxgrid_gfsgmosakndfd.$cycle"
$EXECcode/mdl_racreate < $PARMcode/mdl_u350.cn >> $pgmout 2>errfile
export err=$?; err_chk
echo MDLLOG: `date` -  RACREATE ended
#
...
startmsg
export FORT10="ncepdate"
export FORT25="mdl_wxgrid_gfsgmosaksq.$cycle"
export FORT28="$FIXcode/mdl_mos2000id.tbl"
export FORT27="$FIXgfs_mos/mdl_wxgridprd.$cycle"
export FORT42="mdl_wxgrid_gfsgmosakndfd.$cycle" # grd2grd makes RA, U365 makes sq
...
startmsg
export FORT10="ncepdate"
export FORT31="$FIXgfs_mos/mdl_gmosgb2sect0-1wx" #TLH 2013-11-15 difference in local tables version number.
export FORT32="mdl_wxkeys_aktxt.${cycle}"
export FORT33="$FIXgfs_mos/mdl_gmosakgb2sect3"
export FORT34="$FIXgfs_mos/mdl_gmosakgb2sect4wx.${cycle}"
export FORT35="$FIXgfs_mos/mdl_gmosakgb2sect5wx.${cycle}"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT44="mdl_wxgrid_gfsgmosakndfd.${cycle}"
export FORT60="mdl_gmosakgb2wx.${cycle}.nohead"
...
export FORT33="$FIXgfs_mos/mdl_gmosakgb2sect4ppi.${cycle}"
export FORT34="$FIXgfs_mos/mdl_gmosakgb2sect5ppi.${cycle}"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT44="mdl_wxgrid_gfsgmosakndfd.${cycle}"
export FORT60="mdl_gmosakgb2ppi.${cycle}.nohead"
...
then
   ...
   cpfs mdl_gmosakgb2ppi.$cycle.nohead $COMOUT/mdl_gmosakgb2ppi.$cycle
   cpfs mdl_gmosakgb2wx.$cycle.nohead $COMOUT/mdl_gmosakgb2wx.$cycle
fi

...
#
#######################################################################
#  Job Name: exgfsmos_cowx_extprdgen.sh.ecf 
...
#                                         grid.
#           2016-02-10  Scallion   MDL    Configured for MPMD
#######################################################################
PS4='cowx_extprdgen $SECONDS +'
...
#######################################################################
cpreq $COMIN/mdl_gfsgmoscosq.${cycle} .
cpreq $COMIN/mdl_gfsgmoscotstm_xgrsq.${cycle} .
cpreq $COMIN/mdl_gfsxpopo3_grsq.${cycle} .
cpreq $COMIN/mdl_gfsxptype_grsq.${cycle} .
...
. prep_step
startmsg
export FORT50="mdl_wxgrid_gfsgmosxco.${cycle}"
...
export FORT38="$FIXgfs_mos/mdl_gfsxwxgranlids_co.$cycle"
...
export FORT35="mdl_wxkeysx_cotxt.${cycle}"                      # output ascii keylist
export FORT43="mdl_wxgrid_gfsgmosxco.${cycle}"                  # random access gridded output
export FORT75="mdl_gfsgmoscotstm_xgrsq.${cycle}"                # grsq non-jigsaw u155 tstm input
export FORT76="mdl_cogmoswxtrim_grsq.${cycle}"                  # grsq GMOS Input from GRD2GRD
export FORT77="mdl_gfsxpopo3_grsq.${cycle}"                     # grsq popo3          PS 2014-01-02: ext-range file name
export FORT78="mdl_gfsxptype_grsq.${cycle}"                     # grsq ptype          PS 2014-01-02: ext-range	file name
export FORT79="mdl_gfstsvr_grsq.$cycle"                         # grsq tsvr run by oper # goes to 84-h, used in 12z
...
export FORT32="mdl_wxkeysx_cotxt.${cycle}"
export FORT33="$FIXgfs_mos/mdl_gmoscowxgb2sect3"
export FORT34="$FIXgfs_mos/mdl_gmosxcogb2sect4wx.${cycle}"
export FORT35="$FIXgfs_mos/mdl_gmosxcogb2sect5wx.${cycle}"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT44="mdl_wxgrid_gfsgmosxco.${cycle}"
export FORT60="mdl_gmosxcogb2wx.${cycle}.nohead"
...
export FORT33="$FIXgfs_mos/mdl_gmosxcogb2sect4ppi.${cycle}"
export FORT34="$FIXgfs_mos/mdl_gmosxcogb2sect5ppi.${cycle}"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT44="mdl_wxgrid_gfsgmosxco.${cycle}"
export FORT60="mdl_gmosxcogb2ppi.${cycle}.nohead"
...
. prep_step
startmsg
export FORT11="mdl_gmosxcogb2${element}.$cycle.nohead"
...
then
   ...
   cpfs mdl_gmosxcogb2ppi.$cycle.nohead $COMOUT/mdl_gmosxcogb2ppi.$cycle
   cpfs mdl_gmosxcogb2wx.$cycle.nohead $COMOUT/mdl_gmosxcogb2wx.$cycle
fi

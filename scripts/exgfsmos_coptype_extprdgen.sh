...
export FORT28="$FIXgfs_mos/mdl_gfsxptypecoprd.$cycle"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT44="$FIXgfs_mos/mdl_ptypeCONST_conus2p5.grra"
export FORT60="predsx.$PDY$cyc"
$EXECcode/mdl_mospred < $PARMgfs_mos/mdl_gfsxpredptype.cn > $pgmout 2>errfile #PS 2013-12-20 Renamed to distinguish ext-range from short-range
export err=$?; err_chk
...
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT30="$FIXgfs_mos/mdl_gmosxcoptype.09010531.$cycle"
export FORT31="$FIXgfs_mos/mdl_gmosxcoptype.06010831.$cycle"
export FORT49="mdl_gfsxptype_ra.$PDY$cyc"
...
export FORT60="mdl_gfsxptype_grsq.$PDY$cyc"
...
startmsg
export FORT10="ncepdate"
export FORT24="mdl_gfsxptype_grsq.$PDY$cyc"
...
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT30="mdl_gfsxgrpostptype_grsq.$PDY$cyc"
...
#######################################################################
#
cpreq $FIXcode/mdl_rafile_template mdl_gfsxgrpostptype_grra.$PDY$cyc
...
export FORT34="$FIXgfs_mos/mdl_gmosxcogb2sect5ptype.$cycle"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT44="mdl_gfsxgrpostptype_grra.$PDY$cyc"
...
if test $SENDCOM = 'YES'
then
   cpfs mdl_gfsxptype_grsq.$PDY$cyc $COMOUT/mdl_gfsxptype_grsq.$cycle
   # SEND GRIB2 FILE WITH NO HEADERS TO $COMOUT
   cpfs mdl_gmosxcogb2cprbfz.$cycle.nohead $COMOUT/mdl_gmosxcogb2cprbfz.$cycle
   cpfs mdl_gmosxcogb2cprbsn.$cycle.nohead $COMOUT/mdl_gmosxcogb2cprbsn.$cycle
   cpfs mdl_gmosxcogb2cprbra.$cycle.nohead $COMOUT/mdl_gmosxcogb2cprbra.$cycle
   cpfs mdl_gmosxcogb2cbestc.$cycle.nohead $COMOUT/mdl_gmosxcogb2cbestc.$cycle
fi

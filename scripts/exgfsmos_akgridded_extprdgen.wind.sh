#!/bin/sh
##########################################################################
#  Job Name: exgfsmos_akgridded_extprdgen.wind.sh.ecf 
...
##########################################################################
#
PS4='akgridded_extprdgen.wind $SECONDS +'
#PS4='${PMI_FORK_RANK} $SECONDS ${0/\/gpfs\/hps\/nco\/ops\/nw.*\/gfs_mos.*\/scripts/} +'
echo MDLLOG: `date` - Begin job exgfsmos_akgridded_extprdgen.wind
...
############################################################################
#
if [ ! -f $COMIN/mdl_gfsgmosak.wind.$cycle ]
     then echo 'need successful run of gfsmos_akgridded_prdgen.wind to run properly' >> $pgmout
             export err=1;err_chk
fi

cpreq $COMIN/mdl_gfsgmosak.wind.$cycle .
...
export FORT31="$FIXgfs_mos/mdl_gfsxvect2grid_akdmo.in.wind.$cycle"
export FORT32="$FIXgfs_mos/mdl_gfsxvect2grid_akdmo.out.wind.$cycle"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT61="mdl_goeakmosxmodel.$cycle"
export FORT60="mdl_akxdmogrsq.wind.$cycle"
...
export FORT26="$FIXgfs_mos/mdl_granlsta_ak.lst"
export FORT27="$FIXgfs_mos/mdl_granlsta_ak.tbl"
export FORT16="$FIXgfs_mos/mdl_stationradii_ak.wspd"
export FORT21="$FIXgfs_mos/mdl_gmosakbogusfile.wind"
export FORT28="$FIXgfs_mos/mdl_stationradii_ak.wgst"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT30="mdl_akxdmogrsq.wind.$cycle"
export FORT32="gfspkdfull.$cycle"
export FORT33="gfsxxpkdtimtrp.$cycle"
export FORT37="$FIXgfs_mos/mdl_granlstation_akpairs"
export FORT38="$FIXgfs_mos/mdl_gfsxgranlids_ak.wind.$cycle"
...
export FORT58="$FIXgfs_mos/mdl_u405awuakcn"
export FORT59="$FIXgfs_mos/mdl_u405awvakcn"
export FORT60="$FIXgfs_mos/mdl_u405awspakcn"
export FORT61="$FIXgfs_mos/mdl_u405awdirakcn"
export FORT62="$FIXgfs_mos/mdl_u405awgstakcn"
export FORT80="mdl_gfsmergesta_ak.$cycle"
export FORT81="mdl_gfsxmergesta_ak.wind.$cycle"
...
export FORT26="$FIXgfs_mos/mdl_granlsta_ak.lst"
export FORT27="$FIXgfs_mos/mdl_granlsta_ak.tbl"
export FORT28="$FIXgfs_mos/mdl_gfsxgrpost_ak.wind.$cycle"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT42="mdl_gfsgmosak.wind.$cycle"
export FORT60="mdl_gfsxgmosaksq.wind.$cycle"
startmsg
...
#######################################################################
echo MDLLOG: `date` - Job exgfsmos_akgridded_extprdgen.wind has ended.
#######################################################################

#!/bin/sh
##########################################################################
#  Job Name: exgfsmos_cogridded_extprdgen.wind.sh.ecf 
...
##########################################################################
#
PS4='cogridded_extprdgen.wind $SECONDS +'
#PS4='${PMI_FORK_RANK} $SECONDS ${0/\/gpfs\/hps\/nco\/ops\/nw.*\/gfs_mos.*\/scripts/} +'
set -x

echo MDLLOG: `date` - Begin job exgfsmos_cogridded_extprdgen.wind
...
export FORT31="$FIXgfs_mos/mdl_gfsxvect2grid_codmo.in.wind.$cycle"
export FORT32="$FIXgfs_mos/mdl_gfsxvect2grid_codmo.out.wind.$cycle"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT61="mdl_goemosxmodel.$cycle"
export FORT60="mdl_cogoedmoxgrsq.wind.$cycle"
...
startmsg
export FORT10="ncepdate"
export FORT11="$FIXgfs_mos/mdl_granlsta_copairs.wspd"
export FORT13="$FIXgfs_mos/mdl_gmoscobogusfile.wspd"
export FORT14="$FIXgfs_mos/mdl_stationradii_co.wspd"
export FORT15="$FIXgfs_mos/mdl_gmoscobogusfile.wgst"
export FORT16="$FIXgfs_mos/mdl_stationradii_co.wgst"
export FORT26="$FIXgfs_mos/mdl_granlsta_co.lst"
export FORT27="$FIXgfs_mos/mdl_granlsta_co.tbl"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT30="mdl_cogoedmoxgrsq.wind.$cycle"
export FORT32="mdl_gfspkd.$cycle"
export FORT33="$FIXgfs_mos/mdl_granlsta_copairs.wgst"
export FORT37="$FIXgfs_mos/mdl_granlstation_copairs"
export FORT38="$FIXgfs_mos/mdl_gfsxgranlids_co.wind.$cycle"
export FORT44="$FIXgfs_mos/mdl_analysisgrconst_co"
export FORT51="$FIXgfs_mos/mdl_u405adewcocn"
export FORT52="$FIXgfs_mos/mdl_u405atmpcocn"
export FORT53="$FIXgfs_mos/mdl_u405amaxcocn"
export FORT54="$FIXgfs_mos/mdl_u405amincocn"
export FORT57="$FIXgfs_mos/mdl_u405awspcocn"
export FORT58="$FIXgfs_mos/mdl_u405awucocn"
export FORT59="$FIXgfs_mos/mdl_u405awvcocn"
export FORT60="$FIXgfs_mos/mdl_u405awgstcocn"
export FORT80="mdl_gfsmergesta_co.$cycle"
export FORT81="mdl_gfsxmergesta_co.wind.$cycle"
...
export FORT26="$FIXgfs_mos/mdl_granlsta_co.lst"
export FORT27="$FIXgfs_mos/mdl_granlsta_co.tbl"
export FORT28="$FIXgfs_mos/mdl_gfsxgrpost_co.wind.$cycle"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT42="mdl_gfsgmosco.wind.$cycle"
...
#######################################################################
echo MDLLOG: `date` - Job gfsmos_cogridded_extprdgen.wind has ended.
#######################################################################

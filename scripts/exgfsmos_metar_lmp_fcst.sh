...
#           Dec 20, 2017 SDS  - Continue running old VIS/OBV equations
#                               for LAMP
#
#######################################################################
#
...
export FORT26="$FIXcode/mdl_station.lst"
export FORT27="$FIXcode/mdl_station.tbl"
export FORT28="$FIXcode/mdl_predtofcst.old"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
...
export FORT38="$FIXgfs_mos/mdl_gfsvisobv.04010930.$cycle.old"
export FORT39="$FIXgfs_mos/mdl_gfsvisobv.10010331.$cycle.old"
...
export FORT52="$FIXgfs_mos/mdl_gfsopqcld.04010930.$cycle"
export FORT53="$FIXgfs_mos/mdl_gfsopqcld.10010331.$cycle"
export FORT54="$FIXgfs_mos/mdl_gfsceiling.04010930.$cycle"
export FORT55="$FIXgfs_mos/mdl_gfsceiling.10010331.$cycle"
export FORT49="mdl_gfsmos.$cycle"
startmsg
$EXECcode/mdl_eqneval < $PARMgfs_mos/mdl_gfseval.cn.$cycle.old >> $pgmout 2>errfile
export err=$?; err_chk
...
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT45="$FIXcode/mdl_conststa.old"
export FORT47="$FIXgfs_mos/mdl_threshold.old"
export FORT49="mdl_gfsmos.$cycle"
startmsg
...
if test $SENDCOM = 'YES'
then
  cpfs mdl_gfsmos.$cycle $COMOUT/mdl_gfsmos.$cycle.lmp
fi

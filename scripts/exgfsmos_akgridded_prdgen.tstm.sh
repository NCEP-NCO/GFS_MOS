#!/bin/sh
#######################################################################
#  Job Name: exgfsmos_akgridded_prdgen.tstm.sh.ecf 
...
#
set -x
PS4='akgridded_prdgen.tstm $SECONDS +'
#PS4='${PMI_FORK_RANK} $SECONDS ${0/\/gpfs\/hps\/nco\/ops\/nw.*\/gfs_mos.*\/scripts/} +'
echo MDLLOG: `date` - Begin job exgfsmos_akgridded_prdgen.tstm
...
cpreq $FIXcode/mdl_rafile_template mdl_gfsgmosak.tstm.$cycle
...
export FORT31="$FIXgfs_mos/mdl_gfsvect2grid_tsvrak47.in.$cycle"
export FORT32="$FIXgfs_mos/mdl_gfsvect2grid_tsvrak47.out.$cycle"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT48="mdl_gfstsvrak47.$cycle"
export FORT60="mdl_gfstsvrak47grd.sq.$cycle"
...
startmsg
export FORT10="ncepdate"
export FORT25="mdl_gfstsvrak47grd.sq.$cycle"
export FORT28="$FIXcode/mdl_mos2000id.tbl"
export FORT27="$FIXgfs_mos/mdl_gfsgrd2grd_tsvrak47.ids.$cycle"
...
export FORT28="$FIXgfs_mos/mdl_gfsgrpost_ak.tstm.$cycle"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT42="mdl_gfsgmosak.tstm.$cycle"
export FORT60="mdl_gfsgmosaksq_pp.tstm.$cycle"
startmsg
...
#######################################################################
echo MDLLOG: `date` - Job exgfsmos_akgridded_prdgen.tstm has ended.
#######################################################################

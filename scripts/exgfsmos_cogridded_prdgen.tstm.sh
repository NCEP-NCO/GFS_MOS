#!/bin/sh
#######################################################################
#  Job Name: exgfsmos_cogridded_prdgen.tstm.sh.ecf 
...
#######################################################################
#
PS4='cogridded_prdgen.tstm $SECONDS +'
#PS4='${PMI_FORK_RANK} $SECONDS ${0/\/gpfs\/hps\/nco\/ops\/nw.*\/gfs_mos.*\/scripts/} +'
set -x
echo MDLLOG: `date` - Begin job exgfsmos_cogridded_prdgen.tstm
...
cpreq $FIXcode/mdl_rafile_template_large mdl_gfsgmosco.tstm.$cycle
...
export FORT31="$FIXgfs_mos/mdl_gfsvect2grid_tsvr40km.in.$cycle"
export FORT32="$FIXgfs_mos/mdl_gfsvect2grid_tsvr40km.out.$cycle"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT48="mdl_gfstsvr40.$cycle"
export FORT60="mdl_gfstsvr40grd.sq.$cycle"
...
startmsg
export FORT10="ncepdate"
export FORT25="mdl_gfstsvr40grd.sq.$cycle"
export FORT28="$FIXcode/mdl_mos2000id.tbl"
export FORT27="$FIXgfs_mos/mdl_gfsgrd2grd_tsvr40.ids.$cycle"
...
export FORT28="$FIXgfs_mos/mdl_gfsgrpost_co.tstm.$cycle"
export FORT29="$FIXcode/mdl_mos2000id.tbl"
export FORT42="mdl_gfsgmosco.tstm.$cycle"
...
#######################################################################
echo MDLLOG: `date` - Job exgfsmos_cogridded_prdgen.tstm has ended.
#######################################################################
